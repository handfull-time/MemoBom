...
class KISA_SEED_CBC {
	...
	private static int[] chartoint32_for_SEED_CBC(byte[] in, int inLen) {
		int[] data;
		int len, i;
	...
	private static byte[] int32tochar_for_SEED_CBC(int in[], int inLen) {
		byte[] data;
		int i;
	...
	private static int SEED_CBC_init( KISA_SEED_INFO pInfo, KISA_ENC_DEC enc, byte[] pbszUserKey, byte[] pbszIV ) {
	...
	private static int SEED_CBC_Process( KISA_SEED_INFO pInfo, int[] in, int inLen, int[] out, int[] outLen ) {
	...
	private static int SEED_CBC_Close( KISA_SEED_INFO pInfo, int[] out, int out_offset, int[] outLen ) {
		int nPaddngLeng;
		int i;
	...
	private static final class KISA_ENC_DEC {
	...
	private static final class KISA_SEED_KEY {
	...
	private static final class KISA_SEED_INFO {
		public int encrypt;
